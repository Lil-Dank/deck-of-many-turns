...
const en: Dict = {
  ...
  'pcs.resourcesNote': '(Ki, sorcery points, any custom pool — long rest refills them)',
  'pcs.addResource': 'Add resource',
  'res.add': 'Add',
  'res.editorInfo': 'Custom pools — Ki, sorcery points, anything your table tracks. Name and size them here; spend them from the strip or after an action.',
  'res.spendTitle': 'Spend a resource?',
  'res.spendInfo': 'Did that action cost a resource? Mark it here — or not.',
  'res.done': 'Done',
  'mob.hp': 'HP',
  ...
  'logPanel.jumpToNow': 'Jump to present',
...
const de: Dict = {
  ...
  'pcs.resources': 'Ressourcen',
  'pcs.resourcesNote': '(Ki, Zauberpunkte, beliebige Pools — lange Rast füllt sie auf)',
  'pcs.addResource': 'Ressource hinzufügen',
  'res.add': 'Neu',
  'res.editorInfo': 'Eigene Pools — Ki, Zauberpunkte, was der Tisch eben zählt. Hier benennen und bemessen; ausgegeben wird über die Leiste oder nach einer Aktion.',
  'res.spendTitle': 'Ressource ausgeben?',
  'res.spendInfo': 'Hat die Aktion eine Ressource gekostet? Hier abhaken — oder nicht.',
  'res.done': 'Fertig',
  'mob.hp': 'TP',
  ...
  'logPanel.jumpToNow': 'Zum Jetzt springen',
